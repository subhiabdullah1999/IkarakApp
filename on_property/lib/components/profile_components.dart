            ...
            child: Column(
              ...
              children: [
                ...
                controller.data[0].email != null
                    ? Text(
                        'Email'.tr + ": " + controller.data[0].email.toString(),
    ...
    return GetBuilder<ProfileControllerImp>(
        builder: (controller) => ListView(
              children: [
                ...
                controller.dataPropUserIdAprov.isEmpty
                    ? Center(
                        child: Text(
                              ...
                              return GestureDetector(
                                  onTap: () {
                                    controller.ProdId = controller
                                        .dataPropUserId[index].id!
                                        .toInt();
                                    Get.to(() => HouseDetails(), arguments: {
                                      "ProdId": controller.ProdId
                                    });
                                  },
                                  child: Card(
                ...
                controller.dataPropUserIdReview.isEmpty
                    ? Center(
                        child: Text(
                          "You have not added any property".tr,
                          style: TextStyle(
                ...
                controller.dataPropUserIdfalied.isEmpty
                    ? Center(
                        child: Text(
                          "You have not added any property".tr,
                          style: TextStyle(
